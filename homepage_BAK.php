...
<?php if(!isset($_SESSION['user']))	
	//In case user logs out, then hits back button
...
<!-- For everyone who can log in.. -->
          ...
          <div class="span2" >
            <FORM METHOD="LINK" ACTION="./view.php">
...
?>
	  <div class="span2" >
	    <form method="LINK" action="./log.php">
            <input type="submit" class="btn-maroon" value="Log Tag" style="width:140px;">
            </form>
          </div>

          <div class="span2" >
            <button href class="btn-maroon2">Maintain</button>
          </div>

	  <div class="span2" >
	    <form method="LINK" action="./predefinedEdit.php">
            <input type="submit" class="btn-maroon" value="Predefined Edit" style="width:140px;">
            </form>
          </div> 
